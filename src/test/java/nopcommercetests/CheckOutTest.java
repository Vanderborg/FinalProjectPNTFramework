...
public class CheckOutTest extends CommonAPI {
    ...
    @Test(priority = 1, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 4, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 5, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 7,dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 9, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 11, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 13, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
    ...
    @Test(priority = 16, dataProvider = DataProviderCommerce.CreditData , dataProviderClass = DataProviderCommerce.class)
